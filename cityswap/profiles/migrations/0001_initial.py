    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(default=b'photos/link.jpg', null=True, upload_to=b'photos/', blank=True)),
                ('slug', models.CharField(unique=True, max_length=32, blank=True)),
                ('own_room', models.BooleanField(default=False)),
                ('chat_room_name', models.CharField(max_length=64, null=True, blank=True)),
